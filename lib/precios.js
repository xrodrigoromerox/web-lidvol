...
(function () {
  ...
  window.__LIDVOL__.PRECIOS = {
    ...
    "cero-T": {
      nombre: "Categoría T — Maquinaria pesada (retro y volqueta)",
      precio: 4000, referencial: false,
      duracion: "10 h teóricas + 6 h prácticas · retroexcavadora y volqueta"
    },
    ...
    /* Para quienes ya saben manejar y solo necesitan sacar la licencia.
       Las 8 categorías arrancan con el mismo precio referencial de 200 Bs:
       cuando tengan el precio oficial de cada una, cámbienlo aquí y pongan
       referencial: false en la que corresponda. */
    "lic-JM": {
      nombre: "Licencia JM — Motos (menores 16–18)",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP",
      menor: true
    },
    "lic-JP": {
      nombre: "Licencia JP — Autos particulares (menores 16–18)",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP",
      menor: true
    },
    "lic-M": {
      nombre: "Licencia M — Motocicletas",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
    "lic-P": {
      nombre: "Licencia P — Particular",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
    "lic-A": {
      nombre: "Licencia A — Transporte público liviano",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
    "lic-B": {
      nombre: "Licencia B — Medianos",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
    "lic-C": {
      nombre: "Licencia C — Pesados",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
    "lic-T": {
      nombre: "Licencia T — Maquinaria pesada",
      precio: 200, referencial: true,
      duracion: "1 h de capacitación + banco de preguntas + acompañamiento al SEGIP"
    },
